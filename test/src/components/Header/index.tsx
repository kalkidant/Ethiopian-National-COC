      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-1 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke bg-white p-1.5dark:border-strokedark dark:bg-boxdark lg:hidden"
          >
            <span className="relative block h-[84px] w-5.5 cursor-pointer opacity-0">
